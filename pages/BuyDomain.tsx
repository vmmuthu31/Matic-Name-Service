  ...
  return (
    <div>
      ...
      <div className="absolute w-full h-full bg-[#7b3fe4] p-4 flex flex-col items-center  ">
        ...
        <p className="text-md py-5 text-white">Once the domain is registered it will be Available at <a className="text-blue-400 text-xl underline" href="https://testnets.opensea.io/account" rel="noreferrer" target="_blank">OpenSea</a></p>
      </div>
